...
function fillArticles(){
    ...
    $.ajax({
        ...
        url: "http://fabiostim.altervista.org/assets/php/innovazione.php", //Relative or absolute path to file.php file 
