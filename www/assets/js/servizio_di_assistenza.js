...
function fillAssistByCat(){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            service_content += "<h4>"+service[0].assistance_service_name+"</h4><div class='row'><div class='col-md-6'><p>"+service[0].assistance_service_description+"</p></div><div class='col-md-6'><img src='"+service[0].assistance_service_picture+"' class='img-responsive assistance_picture'></div></div><hr class='red_hr'><hr class='white_hr'>";                
