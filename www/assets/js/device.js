...
function fillDataProduct(){
    ...
    $.ajax({
        ...
        url: "http://fabiotim.altervista.org/assets/php/get_device.php", //Relative or absolute path to file.php file
        data: {productID:id},
	   ...
	   assistance = "<h2>Hai bisogno di assistenza di assistenza?</h2><a href='assistance_for.html?categoryID="+device[0].categoryID+"?productID="+device[0].productID+"'> Clicca qui </a><hr class='red_hr'><hr class='white_hr'>";
