...
function fillDataProduct(){
    ...
    $.ajax({
        ...
        url: "./assets/php/getSL.php", //Relative or absolute path to file.php file
        data: {slID:id},
      ...
      description += "<p id='sec1' class= 'anchor'> </p><h2>Cosa è "+result[0].sl_name+"</h2><p>"+result[0].sl_description +"</p><hr>";    
